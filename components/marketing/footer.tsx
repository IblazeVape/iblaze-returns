...
// Port of linkify/src/components/navigation/footer.tsx
const Footer = () => {
    return (
                        ...
                        <AnimationContainer delay={0.2}>
                            <div className="">
                                ...
                                <ul className="mt-4 text-sm text-muted-foreground">
                                    <li className="mt-2">
                                        <Link href="/marketing#features" className="hover:text-foreground transition-all duration-300">
                                            Features
                                        </Link>
                                    </li>
                                    <li className="mt-2">
                                        <Link href="/marketing#pricing" className="hover:text-foreground transition-all duration-300">
                                            Pricing
                                        </Link>
                                    </li>
                                    <li className="mt-2">
                                        <Link href="/marketing" className="hover:text-foreground transition-all duration-300">
                                            Testimonials
                                        </Link>
                                    </li>
                                    <li className="mt-2">
