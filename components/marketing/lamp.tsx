...
export function LampContainer({ children, className }: { children: React.ReactNode; className?: string }) {
  return (
    <div className={cn("relative z-0 flex min-h-[26rem] w-full flex-col items-center justify-center overflow-hidden rounded-md", className)}>
      ...
      <div className="relative z-50 -mt-52 flex flex-col items-center px-5">
        {children}
      </div>
    </div>
  )
