    ...
    <>
      ...
      <tr>
        <td colSpan={5} style={{ padding: "0 12px 12px 12px", borderTop: "none" }}>
          ...
          ) : statusKey === "awaitingDelivery" ? (
            <p style={{ margin: 0, fontSize: 12, color: "var(--p-color-text-secondary, #616161)" }}>
              Covers several shipping stages (not shipped, on its way, out for delivery, attempted delivery) — edit those sentences under Awaiting delivery.
            </p>
          ) : statusKey === "returnWindowClosed" ? (
            <p style={{ margin: 0, fontSize: 12, color: "var(--p-color-text-secondary, #616161)" }}>
              Covers several reasons (final sale, outside window, etc.) — edit those sentences under Return window closed.
            </p>
          ) : null}
        </td>
      </tr>
