  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          "relative bg-transparent w-(--sidebar-width)",
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-screen w-(--sidebar-width) min-[1025px]:flex",
          side === "left"
          ...
          variant === "inset"
            ? cn(
                "p-2",
                "group-data-[collapsible=icon]:p-0 group-data-[collapsible=icon]:w-(--sidebar-width-icon)"
              )
            : variant === "floating"
      ...
      >
        <div
          ...
          className="bg-sidebar group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[collapsible=icon]:items-center group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-xs"
        >
          {children}
        </div>
      </div>
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "min-[1025px]:peer-data-[variant=inset]:m-2 min-[1025px]:peer-data-[variant=inset]:ml-0 min-[1025px]:peer-data-[variant=inset]:rounded-xl min-[1025px]:peer-data-[variant=inset]:shadow-xs min-[1025px]:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-0",
