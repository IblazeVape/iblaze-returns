...
function DrawerClose({
  ...
  return (
    <DrawerPrimitive.Close
      ...
      // reset browser <button> defaults so it doesn't box-in a child Button
      className="appearance-none bg-transparent border-0 p-0 m-0 w-full cursor-pointer outline-none"
      {...props}
    />
  )
}
  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          // vaul handles slide animation via CSS transforms — don't add animate-in/out classes
...
function DrawerFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("mt-auto flex flex-col gap-2 px-4 pb-4 pt-2", className)}
      {...props}
    />
  )
}
